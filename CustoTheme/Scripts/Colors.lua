...
GameColor = {
	...
	Difficulty = {
		...
		Easy		= color("#00e700"),			-- yellow
		Medium		= color("#ff9600"),			-- red
		Hard		= color("#e70000"),			-- green
		...
		Difficulty_Easy		= color("#00e700"),		-- yellow
		Difficulty_Medium	= color("#ff9600"),		-- red
		Difficulty_Hard		= color("#e70000"),			-- green
