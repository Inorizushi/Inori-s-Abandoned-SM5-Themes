...
t[#t+1] = Def.ActorFrame{
  ...
  LoadActor("footer.png")..{
    InitCommand=cmd(diffusealpha,0);
    OnCommand=cmd(y,0;zoomx,2;sleep,0.5;diffusealpha,1;linear,0.1;zoomx,1;linear,0.1;y,214;sleep,7;linear,0.1;zoomx,2;y,0;sleep,0.1;diffusealpha,0);
  };
