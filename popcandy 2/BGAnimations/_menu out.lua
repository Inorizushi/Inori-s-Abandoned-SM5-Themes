...
t[#t+1] = Def.ActorFrame{
  ...
  Def.Quad{
    InitCommand=cmd(FullScreen;diffuse,color("0,0,0,1");diffusealpha,0;linear,0.3;diffusealpha,1;)
  };
  LoadActor("stagetemp/loadf_0u")..{
    InitCommand=cmd(CenterX;y,SCREEN_CENTER_Y-128);
    OnCommand=cmd(addy,-224;linear,0.2;addy,224;);
  };
  ...
  LoadActor("stagetemp/loadf_1u")..{
    ...
    OnCommand=cmd(addy,-184;bounceend,0.3;addy,184;);
  };
  ...
  LoadActor("stagetemp/loadf_3u")..{
    ...
    OnCommand=cmd(addy,-64;bounceend,0.3;addy,64;);
  };
  ...
  LoadActor("stagetemp/loadf_2u")..{
    ...
    OnCommand=cmd(addx,-640;zoomy,0;linear,0.2;zoomy,1;addx,640;);
  };
  ...
  LoadActor("stagetemp/box.txt")..{
    ...
    OnCommand=cmd(rotationy,-360;zoom,0;linear,0.2;zoom,1;rotationy,0;);
  };
  LoadActor("stagetemp/box.txt")..{
    InitCommand=cmd(effectmagnitude,0,100,0;CenterY;x,SCREEN_CENTER_X+136;z,16);
    OnCommand=cmd(rotationy,-360;zoom,0;linear,0.2;zoom,1;rotationy,0;);
